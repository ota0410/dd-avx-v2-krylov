...
///////////// DD_Vector input ////////////////
void DD_Vector::input(const char* filename){
#ifdef ddavx_debug
...
void DD_Vector::input_mm(FILE *file){
#ifdef ddavx_debug
...
void DD_Vector::input_plane(FILE *file)
{
#ifdef ddavx_debug
...
///////////// DD_Vector output ////////////////
void DD_Vector::output_mm(const char *filename)
{
#ifdef ddavx_debug
...
void DD_Vector::output_plane(const char *filename)
{
#ifdef ddavx_debug
...
///////////// D_Vector input ////////////////
void D_Vector::input(const char* filename){
#ifdef ddavx_debug
...
void D_Vector::input_mm(FILE *file){
#ifdef ddavx_debug
...
void D_Vector::input_plane(FILE *file)
{
#ifdef ddavx_debug
...
///////////// D_Vector output ////////////////
void D_Vector::output_mm(const char *filename)
{
#ifdef ddavx_debug
...
void D_Vector::output_plane(const char *filename)
{
#ifdef ddavx_debug
